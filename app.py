...
def playlists_main(playlistname):
    playlist_name_safe = playlistname.replace(' ', '')
    return render_template(f'{playlist_name_safe}.html')


@app.route('/playlists/hollywood')
def hollywood():
    industry = "Hollywood"
    query_hollywood = """
        PREFIX sp: <http://spotify.com/music#>
